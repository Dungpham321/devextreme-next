...
const MenuPage = () => {
  ...
  //các cột của lưới
  const col = [
    { df: "_id", c: "Mã người dùng", v: false, rq: true },
    { df: "ten_dang_nhap", c: "Tên đăng nhập" },
    { df: "ho_ten", c: "Họ tên" },
    { df: "ngay_tao", c: "Ngày tạo", dt: 'date', f: 'dd/MM/y' },
    { df: "email", c: "Email", cp: 2 },
    { df: "so_dien_thoai", c: "Số điện thoại", cp: 2 }
  ]
  const handleGetData = () => {
  ...
  return (
    <div className="font-[family-name:var(--font-geist-sans)]">
      <h3 className='title-content'>Quản lý Menu</h3>
      <Grid_custom
